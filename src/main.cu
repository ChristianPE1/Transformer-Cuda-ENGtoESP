...
int main()
{
    try
    {
        ...
        if (!test_batch.empty())
        {
            ...
            int epochs = 20;  // Reducir a 5 para pruebas rápidas
            int batch_size = 64;   // Batch aún más pequeño para updates más frecuentes
            float learning_rate = 1e-5;  // Learning rate más agresivo
